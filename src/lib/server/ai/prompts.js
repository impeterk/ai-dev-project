...
export const ai = {
	...
	generateMetaDescription: async (data) => {
		const userMessage = `Given the stringified object as data "${data}", generate a suitable meta description for this webpage. Make sure to output direct suggestion (min 50 and max 60 characters) and nothing else.`;
		const messages = [
			{
				role: 'system',
				content:
